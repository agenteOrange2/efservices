        ...
        <table>
            <tr>
                <td style="width: 75%"><strong>Applicant's Legal
                        Name</strong><br>{{ $userDriverDetail->user->name ?? 'N/A' }}
                    {{ $userDriverDetail->middle_name ?? '' }} {{ $userDriverDetail->last_name ?? 'N/A' }}</td>
        ...
        @if ($userDriverDetail->trainingSchools && $userDriverDetail->trainingSchools->count() > 0)
            ...
            @foreach ($userDriverDetail->trainingSchools as $index => $school)
                <div class="school-item">
                    ...
                    <table>
                        <tr>
                            <td style="width: 50%"><strong>School Name</strong><br>{{ $school->school_name ?? 'N/A' }}
                            </td>
                            <td style="width: 50%"><strong>Phone
                                    Number</strong><br>{{ $school->phone_number ?? 'N/A' }}</td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 33.33%">
                                <strong>Graduated?</strong><br>{{ $school->graduated ? 'Yes' : 'No' }}</td>
                        </tr>
                        <tr>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td style="width: 50%"><strong>City, State,
                                ...
                                {{ $company->zip ?? ($company->masterCompany->zip ?? '') }}</td>
                        </tr>
                        <tr>
                            <td style="width: 50%">
                        ...
                        <tr>
                            ...
                            <td style="width: 50%">
                                <strong>Explanation</strong><br>{{ $company->explanation ?? 'N/A' }}</td>
                        </tr>
                    </table>
                </div>
            @endforeach
    ...
    <div class="section">
        ...
        <div class="signature-box">
            <div class="field">
                ...
                <div>
                    @if (!empty($signature))
                        <img src="data:image/png;base64,{{ base64_encode($signature) }}" alt="Signature"
