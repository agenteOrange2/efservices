        ...
        <div class="min-h-screen bg-gray-50">
            <nav class="bg-navy-900 text-white px-6 py-4">
                <div class="max-w-7xl mx-auto flex justify-between items-center">
                    ...
                    <div class="hidden md:flex space-x-6"><a href="#"
                            class="hover:text-blue-400">Services</a><a href="#"
                            class="hover:text-blue-400">About</a><a href="#"
                        ...
                        @endif
                            <button
                        class="bg-blue-600 px-4 py-2 rounded-lg hover:bg-blue-700 transition">Login</button>
                </div>
            </nav>
            <main>
                <section class="bg-navy-800 text-white py-20">
                    <div class="max-w-7xl mx-auto px-6">
                        <div class="grid md:grid-cols-2 gap-12 items-center">
                            <div>
                                <h1 class="text-4xl md:text-5xl font-bold mb-6 text-gray-600">Smart Fleet Management Solutions</h1>
