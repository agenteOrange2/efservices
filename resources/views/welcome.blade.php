    ...
    <header class="header_nav  text-white">
        ...
        <div id="mobile-menu" class="mobile-menu lg:hidden fixed top-0 right-0 w-4/5 h-full bg-[#0f2231] z-50 p-6">
            ...
            <nav class="space-y-4">
                ...
                <div class="py-2 border-b border-gray-700">
                    <a href="#" class="block font-medium text-white hover:text-[#08459f]">Pages</a>
                </div>
                <div class="py-2 border-b border-gray-700">
                    <a href="#" class="block font-medium text-white hover:text-[#08459f]">Services</a>
                </div>
                <div class="py-2 border-b border-gray-700">
                    <a href="#" class="block font-medium text-white hover:text-[#08459f]">Projects</a>
                </div>
                <div class="py-2 border-b border-gray-700">
                    <a href="#" class="block font-medium text-white hover:text-[#08459f]">Blogs</a>
                </div>
                <div class="py-2 border-b border-gray-700">
                    <a href="#" class="block font-medium text-white hover:text-[#08459f]">Contact</a>
                </div>
            </nav>
                    ...
                    <div class="slide-content">
                        <div class="space-y-8">
                            <span
                                ...
                                Soluciones de Transporte Inteligentes
                            </span>
                            ...
                            <p class="text-xl text-gray-200 max-w-[600px]">
                                Optimice sus operaciones, reduzca costos y mejore la eficiencia con la plataforma líder
    ...
    <section class="w-full py-20 md:py-32" id="testimonials">
        <div class="container px-4 md:px-6 mx-auto">
            <div class="flex flex-col items-center justify-center space-y-4 text-center mb-12">
                ...
                <p class="max-w-[800px] text-xl text-gray-600">
                    Empresas de transporte de todo el país confían en ef Services para optimizar sus operaciones.
                </p>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                    ...
                    <div class="flex flex-col h-full">
                        <div class="mb-6">
                            <p class="text-gray-700 italic">
                                "Desde que implementamos ef Services, hemos reducido nuestros costos operativos en un
                                20% y mejorado significativamente la eficiencia de nuestra flota. El soporte técnico es
                                excepcional."
                            </p>
                        </div>
                        <div class="mt-auto pt-6 border-t border-blue-100">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">Director de Operaciones, Transportes XYZ</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white p-8 rounded-2xl shadow-lg border border-blue-100 relative">
                    ...
                    <div class="flex flex-col h-full">
                        <div class="mb-6">
                            <p class="text-gray-700 italic">
                                "La plataforma es intuitiva y fácil de usar. El soporte técnico es excelente y siempre
                                están disponibles para ayudarnos con cualquier consulta. Ha transformado nuestra
                                operación."
                            </p>
                        </div>
                        <div class="mt-auto pt-6 border-t border-blue-100">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">CEO, Logística Rápida</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white p-8 rounded-2xl shadow-lg border border-blue-100 relative">
                    ...
                    <div class="flex flex-col h-full">
                        <div class="mb-6">
                            <p class="text-gray-700 italic">
                                "La optimización de rutas nos ha permitido ahorrar combustible y tiempo. Nuestros
                                clientes están más satisfechos con los tiempos de entrega más precisos y la visibilidad
                                en tiempo real."
                            </p>
                        </div>
                        <div class="mt-auto pt-6 border-t border-blue-100">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">Gerente de Flota, Transportes Nacionales</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="mt-16 grid md:grid-cols-4 gap-8">
                <div class="bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col items-center text-center">
                    ...
                    <p class="text-gray-600">Empresas confían en nosotros</p>
                </div>
                ...
                <div class="bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col items-center text-center">
                    ...
                    <p class="text-gray-600">Vehículos monitoreados</p>
                </div>
                ...
                <div class="bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col items-center text-center">
                    ...
                    <p class="text-gray-600">Reducción de costos promedio</p>
                </div>
                ...
                <div class="bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col items-center text-center">
                    ...
                    <p class="text-gray-600">Tiempo de actividad garantizado</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid gap-8 lg:grid-cols-2 lg:gap-12 items-center">
                <div class="space-y-6">
                    ...
                    <p class="text-xl text-blue-100 max-w-[600px]">
                        Contáctenos hoy mismo para una demostración personalizada y descubra cómo ef Services puede
                        transformar sus operaciones de transporte.
                    </p>
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 max-w-[600px]">
                        <div class="bg-blue-800/50 p-6 rounded-xl">
                            ...
                            <h3 class="text-xl font-semibold mb-2">Soporte Dedicado</h3>
                            <p class="text-blue-100">Equipo de soporte especializado disponible 24/7 para ayudarle.</p>
                        </div>

                        <div class="bg-blue-800/50 p-6 rounded-xl">
                            <i data-lucide="zap" class="h-8 w-8 mb-4 text-blue-200"></i>
                            <h3 class="text-xl font-semibold mb-2">Implementación Rápida</h3>
                            <p class="text-blue-100">Puesta en marcha en menos de 48 horas para su flota completa.</p>
                        </div>
                    </div>
                ...
                <div class="relative">
                    ...
                    <div
                        ...
                        <h3 class="text-2xl font-bold mb-6">Solicite información</h3>
                        <div class="space-y-4">
                            ...
                            <div class="space-y-2">
                                <label class="text-sm font-medium">Tamaño de flota</label>
                                <select
                                    class="w-full px-4 py-3 rounded-lg bg-blue-700/50 border border-blue-600 text-white">
                                    <option>1-10 vehículos</option>
                                    <option>11-30 vehículos</option>
                                    <option>31-100 vehículos</option>
