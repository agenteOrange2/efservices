...
@section('title', 'Create User Carrier')
@php
    $breadcrumbLinks = [
        ...
        <div class="col-span-12 sm:col-span-10 sm:col-start-2">
            <div class="mt-7">
                <div class="box box--stacked flex flex-col">
                    <form action="{{ route('admin.user_carrier.store') }}" method="POST" enctype="multipart/form-data"
                        id="userForm">
                        @csrf
                        <div class="p-7">
                                ...
                                <div class="mt-3 w-full flex-1 xl:mt-0">
                                    <select data-tw-merge aria-label="Default select example"
                                        ...
                                        <option value="{{ App\Models\UserCarrier::STATUS_PENDING }}" 
                                            {{ old('status') == App\Models\UserCarrier::STATUS_PENDING ? 'selected' : '' }}>
                                            Pending
                                        </option>
                                        <option value="{{ App\Models\UserCarrier::STATUS_ACTIVE }}" 
                                            {{ old('status') == App\Models\UserCarrier::STATUS_ACTIVE ? 'selected' : '' }}>
                                            Active
                                        </option>
                                        <option value="{{ App\Models\UserCarrier::STATUS_INACTIVE }}" 
                                            {{ old('status') == App\Models\UserCarrier::STATUS_INACTIVE ? 'selected' : '' }}>
                                            Inactive
                                        </option>
                                    </select>
                                    @error('status')
