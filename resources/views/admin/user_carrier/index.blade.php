                    ...
                    <div class="bg-white rounded-lg shadow-lg max-w-lg w-full">
                        <div class="p-6">
                            ...
                            <p class="mt-4 text-gray-600">
                                You have reached the maximum number of users allowed. Please upgrade your plan or contact
                                the administrator
                            </p>
                            ...
                            <tbody>
                                @forelse ($userCarriers as $userCarrier)
                                    <tr>
                                        ...
                                        <td class="px-5 border-b border-dashed py-4">
                                            <a
                                                href="{{ route('admin.carrier.user_carriers.edit', ['carrier' => $carrier->slug, 'userCarrierDetails' => $userCarrier->carrierDetails->id]) }}">
                                                Editar
                                            </a>
