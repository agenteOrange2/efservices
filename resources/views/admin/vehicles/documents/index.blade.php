    ...
    <div class="col-span-12">
        <div class="flex flex-col gap-y-3 md:h-10 md:flex-row md:items-center">
            ...
            <div class="flex flex-col gap-x-3 gap-y-2 sm:flex-row md:ml-auto">
                ...
                <x-base.button data-tw-toggle="modal" data-tw-target="#add-document-modal"
            ...
            <div class="box box--stacked p-5 bg-white rounded-lg shadow">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <div class="font-medium text-xl">{{ $vehicle->documents->where('status', 'active')->count() }}</div>
                    </div>
                </div>
            </div>
            <div class="box box--stacked p-5 bg-white rounded-lg shadow">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <div class="font-medium text-xl">{{ $vehicle->documents->where('status', 'expired')->count() }}</div>
                    </div>
                </div>
            </div>
            <div class="box box--stacked p-5 bg-white rounded-lg shadow">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <div class="font-medium text-xl">{{ $vehicle->documents->where('status', 'pending')->count() }}</div>
                    </div>
                </div>
            </div>
            <div class="box box--stacked p-5 bg-white rounded-lg shadow">
            ...
            <div class="box box--stacked">
                <div class="box-header bg-slate-50 p-5 border-b border-slate-200/60">
                    <div class="flex flex-col gap-y-3 md:flex-row md:items-center">
                        ...
                        <div class="flex flex-col gap-x-3 gap-y-2 sm:flex-row md:ml-auto">
                            <div class="relative">
                                <input type="text" class="form-input pl-9 w-full sm:w-64" placeholder="Search documents..." id="document-search">
                ...
                <div class="box-body p-5">
                    ...
                    <div class="text-center py-10">
                        ...
                        <div class="mt-3">
                            <button type="button" data-tw-toggle="modal" data-tw-target="#add-document-modal" class="btn btn-primary btn-sm">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-left border-b border-slate-200/60" id="documents-table">
                            <thead>
                                <tr>
                                    <th class="whitespace-nowrap">Document Type</th>
                                    <th class="whitespace-nowrap">Document #</th>
                                    <th class="whitespace-nowrap">Issued Date</th>
                                    <th class="whitespace-nowrap">Expiration Date</th>
                            ...
                            <tbody>
                                ...
                                <tr class="document-row">
                                    ...
                                    <td>
                                        ...
                                        <div class="{{ $document->isExpired() ? 'text-danger' : ($document->isAboutToExpire() ? 'text-warning' : 'text-success') }}">
                                            {{ $document->expiration_date->format('m/d/Y') }}
                                            @if($document->isExpired())
                                            <span class="text-xs bg-danger/10 text-danger px-1.5 py-0.5 rounded">Expired</span>
                                            @elseif($document->isAboutToExpire())
                                            <span class="text-xs bg-warning/10 text-warning px-1.5 py-0.5 rounded">Expiring Soon</span>
                                            @endif
                                        </div>
                                        @else
            ...
            <x-base.dialog.description>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <x-base.form-input id="document_number" name="document_number" type="text" value="{{ old('document_number') }}"
                    ...
                    <div class="col-span-1">
                        ...
                        <x-base.form-input id="issued_date" name="issued_date" type="date" value="{{ old('issued_date') }}" />
                        @error('issued_date')
                        <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-span-1">
                        ...
                        <x-base.form-input id="expiration_date" name="expiration_date" type="date" value="{{ old('expiration_date') }}" />
                    ...
                    <div class="col-span-2">
                        <x-base.form-label for="document_file">Upload Document <span class="text-danger">*</span></x-base.form-label>
                        <div class="border-2 border-dashed rounded-md pt-4 pb-6 px-4 cursor-pointer" id="file-upload-box">
                            <div class="text-center">
                                ...
                                <input id="document_file" name="document_file" type="file" class="hidden" accept=".pdf,.jpg,.jpeg,.png" required>
                            </div>
                    ...
                    <div class="col-span-2">
                        ...
                        <x-base.form-textarea id="notes" name="notes" placeholder="Additional information about this document">{{ old('notes') }}</x-base.form-textarea>
                        @error('notes')
                        <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (editDocumentBtns.length > 0) {
            editDocumentBtns.forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    form.action = `{{ route('admin.vehicles.documents.index', $vehicle->id) }}/${documentId}`;
                    ...
                    if (hasFile) {
                        ...
                        previewLink.href = `{{ route('admin.vehicles.documents.index', $vehicle->id) }}/${documentId}/preview`;
                        ...
                        downloadLink.href = `{{ route('admin.vehicles.documents.index', $vehicle->id) }}/${documentId}/download`;
        ...
        window.confirmDelete = function(vehicleId, documentId) {
            ...
            form.action = `{{ route('admin.vehicles.documents.destroy', [$vehicle->id, 'DOCUMENT_ID']) }}`.replace('DOCUMENT_ID', documentId);
