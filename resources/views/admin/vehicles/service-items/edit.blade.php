    ...
    <div class="col-span-12">
        ...
        <div class="box box--stacked mt-5">
            ...
            <div class="box-body p-5">
                ...
                <form action="{{ route('admin.vehicles.service-items.update', [$vehicle->id, $serviceItem->id]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                                ...
                                <div class="border rounded p-2 flex items-center justify-between bg-slate-50">
                                    ...
                                    <div class="flex">
                                        ...
                                        <form id="delete-file-{{ $media->id }}" action="{{ route('admin.vehicles.service-items.delete-file', [$vehicle->id, $serviceItem->id, $media->id]) }}" method="POST" class="hidden">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </div>
