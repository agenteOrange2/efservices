        ...
        <div class="col-span-12">
            ...
            <div class="mt-5">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="box box--stacked">
                        <div class="box-header">
                            <div class="box-title">Registro e Inspección</div>
                        </div>
                        <div class="box-body p-5">
                            <table class="w-full">
                                <tr>
                            ...
                            <!-- Conductor Asignado -->
                            <div class="mt-6">
                                <h3 class="text-base font-medium mb-3">Conductor Asignado</h3>
                                @if ($vehicle->driver)
                            ...
                            <!-- Estado -->
                            <div class="mt-6">
                                <h3 class="text-base font-medium mb-3">Estado</h3>
                ...
                <div class="box box--stacked mt-5">
                    <div class="box-header">
                        <div class="box-title">Historial de Servicio Reciente</div>
                    </div>
                    <div class="box-body p-5">
                        <!-- Botones arriba de la tabla -->
                        <div class="flex flex-wrap gap-2 mb-4">
                            <button type="button" class="btn btn-outline-primary" data-tw-toggle="modal"
        ...
        <form action="{{ route('admin.vehicles.service-items.store', $vehicle->id) }}" method="POST">
            ...
            <x-base.dialog.description class="grid grid-cols-12 gap-4 gap-y-3">
                ...
                <div class="col-span-12 sm:col-span-6">
                    ...
                    <x-base.form-input id="service_date" name="service_date" type="date" required value="{{ date('Y-m-d') }}" />
                </div>
                <div class="col-span-12 sm:col-span-6">
                    <x-base.form-label for="next_service_date">Fecha Próximo Servicio</x-base.form-label>
                    <x-base.form-input id="next_service_date" name="next_service_date" type="date" required value="{{ date('Y-m-d', strtotime('+3 months')) }}" />
                ...
                <div class="col-span-12 sm:col-span-6">
                    ...
                    <x-base.form-input id="unit" name="unit" type="text" placeholder="Número de unidad" value="{{ $vehicle->company_unit_number }}" required />
                </div>
                <div class="col-span-12 sm:col-span-6">
                    <x-base.form-label for="service_tasks">Tareas de Servicio</x-base.form-label>
                    <x-base.form-input id="service_tasks" name="service_tasks" type="text" placeholder="Ej: Cambio de aceite, inspección de frenos" required />
                </div>
                
                <!-- Tercera fila -->
                <div class="col-span-12 sm:col-span-6">
                    <x-base.form-label for="vendor_mechanic">Proveedor/Mecánico</x-base.form-label>
                    <x-base.form-input id="vendor_mechanic" name="vendor_mechanic" type="text" placeholder="Ej: Taller Mecánico XYZ" required />
                </div>
                <div class="col-span-12 sm:col-span-6">
                    <x-base.form-label for="cost">Costo ($)</x-base.form-label>
                    <x-base.form-input id="cost" name="cost" type="number" step="0.01" min="0" placeholder="0.00" required />
                </div>
                
                <!-- Cuarta fila -->
                <div class="col-span-12 sm:col-span-6">
                    <x-base.form-label for="odometer">Lectura del Odómetro</x-base.form-label>
                    <x-base.form-input id="odometer" name="odometer" type="number" min="0" placeholder="Ej: 50000" />
                </div>
                <div class="col-span-12 sm:col-span-6">
                    <x-base.form-label for="description">Descripción</x-base.form-label>
                    <x-base.form-textarea id="description" name="description" placeholder="Detalles adicionales sobre el servicio" rows="3"></x-base.form-textarea>
                </div>
