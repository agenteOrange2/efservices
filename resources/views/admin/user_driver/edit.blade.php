                            ...
                            <div x-data="{
                                ...
                                <div x-show="activeTab === 'general'">
                                    ...
                                    <div class="bg-white p-4 rounded-lg shadow">
                                        ...
                                        {{-- Email --}}
                                        <div class="mt-5 block flex-col pt-5 sm:flex xl:flex-row xl:items-center" x-data>
                                            <div class="mb-2 sm:mb-0 sm:mr-5 xl:mr-14 xl:w-60">
                                                <div class="text-left">
                                                    <div class="flex items-center">
                                        ...
                                        <div x-show="openSections.address"
                                            ...
                                            <div class="mt-4 grid grid-cols-2 gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <x-base.form-input type="date" x-model="toDate" :value="$mainAddress?->to_date?->format('Y-m-d')"
                                                        x-bind:min="fromDate" @change="validateAndCalculateDates()"
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <template x-for="(addr, index) in previousAddresses"
                                                    ...
                                                    <div class="hidden">
                                                        ...
                                                        <input type="hidden" :name="`previous_addresses[${index}][city]`"
                                                            :value="addr.city">
                                                        <input type="hidden"
                                        ...
                                        <div x-show="openSections.applicationDetails"
                                            ...
                                            <div class="mt-5 block flex-col pt-5 sm:flex xl:flex-row xl:items-center">
                                                ...
                                                <div class="mt-3 w-full flex-1 xl:mt-0">
                                                    <div class="flex items-center mt-4">
                                                        <x-base.form-check.input class="mr-2.5 border" type="checkbox"
                                                            name="has_twic_card" value="1" x-model="hasTwicCard" />
                                                        <span class="cursor-pointer select-none">
                                                            I have a TWIC card
                                                        </span>
                                                    </div>
                                                    ...
                                                    <template x-if="showOtherReferral">
                                                        <div class="mt-2">
                                                            <x-base.form-input name="how_did_hear_other" type="text"
                                                                placeholder="Specify source" :value="old(
                                                                    'how_did_hear_other',
                                                                    $userDriverDetail->application?->details
                                                                        ?->how_did_hear_other,
                                                                )" />
                                            ...
                                            <div class="mt-5 block flex-col pt-5 sm:flex xl:flex-row xl:items-center">
                                                ...
                                                <div class="mt-3 w-full flex-1 xl:mt-0" x-data="{
                                                    hasWorkHistory: {{ count($workHistories) > 0 ? 'true' : 'false' }},
                                                    workHistories: {{ Js::from(
                                                        $workHistories->map(function ($history) {
                                                                return [
                                                                    'id' => $history->id,
                                                            ...
                                                            <template x-for="(history, index) in workHistories"
                                                                ...
                                                                <div class="mb-6 border-b pb-6">
                                                                    <div class="flex justify-between items-center mb-4">
                                                                        ...
                                                                        <button type="button"
                                                                            @click="workHistories.splice(index, 1)"
                                                                    ...
                                                                    <div class="mb-4">
                                                                        ...
                                                                        <input type="text" x-model="history.location"
