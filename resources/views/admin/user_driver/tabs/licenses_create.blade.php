        ...
        <template x-for="(experience, index) in experiences" :key="index">
            <div class="experience-entry border rounded-lg p-4 mb-4">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <div class="flex">
                        <x-base.button type="button" @click="addExperience()" class="border border-primary/50 px-4 py-2 rounded text-primary hover:text-white hover:bg-primary transition">                            
                            Add Another Vehicle
                        </x-base.button>
