...
<body>
    ...
    <div>
        ...
        <div class="center blue">drugs@efcts.com</div>
    </div>
  ...
  <div class="section">
    <table class="info-table">
        ...
        <tr>
            <td><strong>
                    Ef Service Truck Office
                </strong><br>
                801 Magnolia St, <br>
                Kermit, TX 79745 <br>
                (432) 853-5493
                <span class="blue">drugs-testing@efcts.com</span>
            </td>
        </tr>
    </table>
    </div>
    <div class="footer-box">
        <p class="center">This document is confidential and contains private health information.</p>
        <p class="center">Unauthorized distribution is prohibited.</p>
        <p class="center">Generated by EF Services Testing Drugs Module | Report #{{ $driverTesting->id }} |
