        ...
        <div class="col-span-12">
            <div class="flex flex-col gap-y-3 md:h-10 md:flex-row md:items-center">
                ...
                {{-- <div class="flex flex-col gap-x-3 gap-y-2 sm:flex-row md:ml-auto">
                    <a href="{{ route('admin.drivers.export') }}" class="btn btn-primary">
                        <i data-lucide="Download" class="mr-2 h-4 w-4 stroke-[1.3]"></i>
                        Export Drivers
                    </a>
                </div> --}}
            </div>
            <div class="mt-3.5 flex flex-col gap-8">
                ...
                <div class="box box--stacked flex flex-col">
                                    ...
                                    <x-base.table.tr class="[&_td]:last:border-b-0">
                                        ...
                                        <x-base.table.td class="w-80 border-dashed py-4">
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-3.5">
                                                    <a class="whitespace-nowrap font-medium" href="{{ route('admin.drivers.show', $driver->id) }}">
                                        ...
                                        <x-base.table.td class="border-dashed py-4">
                                            <div class="flex items-center justify-center {{ $driver->status == App\Models\UserDriverDetail::STATUS_ACTIVE ? 'text-success' : 'text-danger' }}">
                                                ...
                                                <x-base.menu class="h-5">
                                                    ...
                                                    <x-base.menu.items class="w-40">
                                                        <x-base.menu.item>
                                                            ...
                                                            <a href="{{ route('admin.drivers.show', $driver->id) }}">View</a>
                                                        </x-base.menu.item>
                                                        <x-base.menu.item>
                                                            <x-base.lucide class="mr-2 h-4 w-4" icon="Download" />
                                                            <a href="{{ route('admin.drivers.documents.download', $driver->id) }}">Documents</a>
                                                        </x-base.menu.item>
                                                        @if($driver->status == App\Models\UserDriverDetail::STATUS_ACTIVE)
                                                            <form action="{{ route('admin.drivers.deactivate', $driver->id) }}" method="POST">
                                                                @csrf
                                                                @method('PUT')
                                                                <x-base.menu.item class="text-danger">
                                                                    <x-base.lucide class="mr-2 h-4 w-4" icon="UserMinus" />
                                                                    <button type="submit" class="bg-transparent border-0 p-0 text-inherit">Deactivate</button>
                                                                </x-base.menu.item>
                                                            </form>
                                                        @else
                                                            <form action="{{ route('admin.drivers.activate', $driver->id) }}" method="POST">
                                                                @csrf
                                                                @method('PUT')
                                                                <x-base.menu.item class="text-success">
                                                                    <x-base.lucide class="mr-2 h-4 w-4" icon="UserCheck" />
                                                                    <button type="submit" class="bg-transparent border-0 p-0 text-inherit">Activate</button>
                                                                </x-base.menu.item>
                                                            </form>
                                                        @endif
                                                    </x-base.menu.items>
                    ...
                    <div class="flex-reverse flex flex-col-reverse flex-wrap items-center gap-y-2 p-5 sm:flex-row">
                        ...
                        <x-base.form-select class="rounded-[0.5rem] sm:w-20" name="per_page" onchange="this.form.submit()">
