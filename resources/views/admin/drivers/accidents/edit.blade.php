                ...
                <div class="mt-8 border-t pt-6" id="media_files">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div class="border rounded-md p-2 relative group">
                            ...
                            <div class="absolute flex top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                <a href="{{ $media->getUrl() }}" target="_blank" class="bg-primary text-white p-1 rounded mr-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-eye-icon lucide-eye w-4 h-4">
