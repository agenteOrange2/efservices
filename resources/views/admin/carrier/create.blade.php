        ...
        <div class="col-span-12 sm:col-span-10 sm:col-start-2">            
            <div class="mt-7">
                ...
                <div class="box box--stacked flex flex-col">
                    <form action="{{ route('admin.carrier.store') }}" method="POST" enctype="multipart/form-data" id="userForm">
                        @csrf
                        <div class="p-7">
                            ...
                            <div class="mt-5 block flex-col pt-5 first:mt-0 first:pt-0 sm:flex xl:flex-row xl:items-center">
                                ...
                                <div class="mt-3 w-full flex-1 xl:mt-0">
                                    ...
                                    <x-base.form-input class="mt-4" name="state" type="text" placeholder="Enter State"
                                    ...
                                    <div class="grid-cols-2 gap-2 sm:grid my-6">
                                        ...
                                        <x-base.input-group>
                                            ...
                                            <x-base.form-input class="w-full" type="text" name="ein_number"
                                                id="ein_number" value="{{ old('ein_number') }}"
                                        ...
                                        <x-base.input-group>
                                            ...
                                            <x-base.form-input class="w-full" type="text" name="dot_number"
                                                id="dot_number" value="{{ old('dot_number') }}"
                                        ...
                                        <x-base.input-group>
                                            ...
                                            <x-base.form-input class="w-full" type="text" name="mc_number"
                                                id="mc_number" value="{{ old('mc_number') }}" placeholder="MC Number" />
                                        </x-base.input-group>
                                        ...
                                        <x-base.input-group>
                                            ...
                                            <x-base.form-input class="w-full" type="text" name="state_dot"
                                                id="state_dot" value="{{ old('state_dot') }}" placeholder="State DOT" />
                                        </x-base.input-group>
