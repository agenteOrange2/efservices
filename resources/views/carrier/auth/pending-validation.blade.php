        ...
        <div class="w-full max-w-md bg-white rounded-2xl shadow-lg overflow-hidden">
                    ...
                    <div class="relative">
                        <svg class="w-32 h-32" viewBox="0 0 100 100">
                            ...
                            <circle cx="50" cy="50" r="45" fill="none" stroke="url(#gradient)"
                                stroke-width="6" stroke-dasharray="282.5" stroke-dashoffset="85" stroke-linecap="round"
                                class="animate-pulse" />
                            <defs>
                        ...
                        <div class="absolute inset-0 flex flex-col items-center justify-center">
                            <div class="text-2xl font-bold text-blue-600">
                                {{ $estimatedTime['estimated_days_remaining'] }}</div>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <p class="text-sm text-blue-700">
                            Your banking information is encrypted and secure. Our team is validating the details to
                            ensure account safety and compliance.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="flex p-4 space-x-3">
                <a href="mailto:support@efcts.com"
                    class="flex-1 py-3 px-4 bg-white border-2 border-gray-200 text-gray-700 rounded-lg font-medium text-center hover:bg-gray-50 hover:border-gray-300 transition-all duration-200 flex items-center justify-center">
                ...
                <form method="POST" action="{{ route('custom.logout') }}" class="flex-1">
                    @csrf
                    <button type="submit"
                        class="w-full py-3 px-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg font-medium hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 flex items-center justify-center">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
