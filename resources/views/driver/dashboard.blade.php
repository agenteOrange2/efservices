            ...
            <div>
                ...
                <div class="box box--stacked mt-3.5 p-5">
                        ...
                        <div class="sm:mr-auto">
                            ...
                            <div class="flex items-center mt-1">
                                ...
                                <div class="flex items-center ml-2 -mr-1 text-xs text-success">
                                    11%
                                    <x-base.lucide class="w-4 h-4 ml-px" icon="ChevronUp" />
                                </div>
                            </div>
                        </div>
                        <div class="relative">
                    ...
                    <div class="flex flex-col items-center gap-3 mt-5 sm:flex-row">
                        ...
                        <a class="flex items-center text-primary sm:ml-auto" href="">
                ...
                <div class="grid grid-cols-2 gap-6">
                        ...
                        <div class="relative h-1/2">
                            ...
                            <div class="flex items-center mt-1">
                                ...
                                <div class="flex items-center ml-2 -mr-1 text-xs text-danger">
                                    4%
                                    <x-base.lucide class="w-4 h-4 ml-px" icon="ChevronDown" />
                                </div>
                            </div>
                            <div class="mt-4">
                                <x-report-line-chart-3 class="-mb-3 -ml-1.5" height="h-[101px]" />
                            </div>
                            <x-base.menu class="absolute top-0 right-0">
                                <x-base.menu.button class="w-5 h-5 text-slate-500">
                                    <x-base.lucide class="w-6 h-6 fill-slate-400/70 stroke-slate-400/70"
                                        icon="MoreVertical" />
                                </x-base.menu.button>
                    ...
                    <div class="box box--stacked col-span-2 mt-3.5 p-5 md:col-span-1 lg:col-span-2">
                        <div class="relative h-1/2">
                            ...
                            <div class="mt-4">
                                <x-report-line-chart-1 class="-mb-3 -ml-1.5" height="h-[101px]" />
                            </div>
                            <x-base.menu class="absolute top-0 right-0">
                                <x-base.menu.button class="w-5 h-5 text-slate-500">
                                    <x-base.lucide class="w-6 h-6 fill-slate-400/70 stroke-slate-400/70"
        ...
        <div class="flex flex-col col-span-12 gap-y-10 md:col-span-6 2xl:col-span-4">
            <div>
                ...
                <div class="box box--stacked mt-3.5 p-5">
                    ...
                    <x-report-donut-chart-4 class="relative z-10" height="h-[100px]" />
            ...
            <div>
                ...
                <div class="box box--stacked mt-3.5 p-5">
                    ...
                    <div class="flex items-center">
                        <x-base.lucide class="mr-2.5 h-6 w-6 fill-warning/10 text-warning" icon="Zap" />
                        <div class="text-base">
                    ...
                    <x-base.button class="mt-2.5 w-full border-slate-300/60 hover:bg-slate-50"
                        variant="outline-secondary">
                        <x-base.lucide class="mr-2 h-4 w-4 stroke-[1.3]" icon="ChevronRightSquare" />
                        Acknowledge
                    </x-base.button>
                </div>
            </div>
                        ...
                        <x-base.tab.panels class="mt-10">
                            <x-base.tab.panel id="example-1" selected>
                                <div class="w-4/5 mx-auto">
                                    <x-report-bar-chart class="relative z-10" height="h-[121px]" />
                                </div>
