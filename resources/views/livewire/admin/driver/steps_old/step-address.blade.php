        <div>
            ...
            <div class="p-4 border rounded bg-gray-50 mb-6">
                ...
                <div class="mb-2">
                    <label class="flex items-center">
                        <input type="checkbox" x-model="lived_three_years" class="mr-2">
            ...
            <!-- Previous Addresses (if not lived at current address for 3+ years) -->
            <div x-show="!lived_three_years" x-transition class="mb-6">
                ...
                @foreach ($previous_addresses as $index => $address)
                    <div class="p-4 border rounded bg-gray-50 mb-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                <label class="block mb-1">Address Line 1 *</label>
                                <input type="text" wire:model="previous_addresses.{{ $index }}.address_line1"
                            ...
                            <div>
                                <label class="block mb-1">Address Line 2</label>
                                <input type="text" wire:model="previous_addresses.{{ $index }}.address_line2"
                                    class="w-full px-3 py-2 border rounded">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                            <div>
                                <label class="block mb-1">City *</label>
                                <input type="text" wire:model="previous_addresses.{{ $index }}.city"
                                    class="w-full px-3 py-2 border rounded">
                            ...
                            <div>
                                <label class="block mb-1">ZIP Code *</label>
                                <input type="text" wire:model="previous_addresses.{{ $index }}.zip_code"
                                    class="w-full px-3 py-2 border rounded">
