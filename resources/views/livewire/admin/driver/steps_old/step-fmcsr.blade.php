<!-- Guardar en resources/views/livewire/admin/driver/steps/step-fmcsr.blade.php -->
<div class="bg-white p-4 rounded-lg shadow">
    ...
    <div class="mb-6 border-b pb-4">
        <div x-data="{ isDisqualified: @entangle('is_disqualified') }">
            ...
            <div x-show="isDisqualified" x-transition class="ml-6 mt-2">
                ...
                <textarea 
                    wire:model="disqualified_details"
                    rows="2"
    ...
    <div class="mb-6 border-b pb-4">
        <div x-data="{ isSuspended: @entangle('is_license_suspended') }">
            <div class="flex items-center mb-2">
                <input type="checkbox" 
                    id="is_license_suspended" 
                    wire:model="is_license_suspended" 
                    x-model="isSuspended"
                    class="form-checkbox h-4 w-4 text-primary border-gray-300 rounded mr-2">
    ...
    <div class="mb-6 border-b pb-4">
        <div x-data="{ isDenied: @entangle('is_license_denied') }">
            <div class="flex items-center mb-2">
                <input type="checkbox" 
                    id="is_license_denied" 
                    wire:model="is_license_denied" 
                    x-model="isDenied"
                    class="form-checkbox h-4 w-4 text-primary border-gray-300 rounded mr-2">
            ...
            <div x-show="isDenied" x-transition class="ml-6 mt-2">
                <label class="block text-sm font-medium text-gray-700 mb-1">Please provide additional details</label>
                <textarea 
                    wire:model="denial_details"
                    rows="2"
                    class="w-full text-sm border-slate-200 shadow-sm rounded-md py-2 px-3"
                    placeholder="Enter details about denial..."></textarea>
    ...
    <div class="mb-6 border-b pb-4">
        <div x-data="{ hasPositiveTest: @entangle('has_positive_drug_test') }">
            <div class="flex items-center mb-2">
                <input type="checkbox" 
                    id="has_positive_drug_test" 
                    wire:model="has_positive_drug_test" 
                    x-model="hasPositiveTest"
                    class="form-checkbox h-4 w-4 text-primary border-gray-300 rounded mr-2">
            ...
            <div x-show="hasPositiveTest" x-transition class="ml-6 mt-2">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="text" 
                            wire:model="substance_abuse_professional"
                            class="w-full text-sm border-slate-200 shadow-sm rounded-md py-2 px-3"
                ...
                <div class="mb-2 p-3 bg-gray-50 rounded-md">
                    ...
                    <div class="flex items-center">
                        <input type="checkbox"
                            id="consent_to_release"
                            wire:model="consent_to_release"
                            class="form-checkbox h-4 w-4 text-primary border-gray-300 rounded mr-2">
    ...
    <div class="mb-6 border-b pb-4">
        <div x-data="{ hasDutyOffenses: @entangle('has_duty_offenses') }">
            <div class="flex items-center mb-2">
                <input type="checkbox" 
                    id="has_duty_offenses" 
                    wire:model="has_duty_offenses" 
                    x-model="hasDutyOffenses"
                    class="form-checkbox h-4 w-4 text-primary border-gray-300 rounded mr-2">
            ...
            <div x-show="hasDutyOffenses" x-transition class="ml-6 mt-2">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="date" 
                            wire:model="recent_conviction_date"
                            class="w-full text-sm border-slate-200 shadow-sm rounded-md py-2 px-3">
    ...
    <div class="mb-6 p-4 bg-gray-50 rounded-lg">
        ...
        <div class="flex items-center">
            <input type="checkbox" 
                id="consent_driving_record" 
                wire:model="consent_driving_record"
                class="form-checkbox h-4 w-4 text-primary border-gray-300 rounded mr-2">
