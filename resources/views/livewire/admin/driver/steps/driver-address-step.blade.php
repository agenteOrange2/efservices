<div>
    ...
    <div class="p-4 border rounded bg-gray-50 mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div>
                ...
                <x-base.form-input type="text" wire:model="address_line1" class="w-full px-3 py-2 border rounded" />
                @error('address_line1')
            ...
            <div>
                ...
                <x-base.form-input type="text" wire:model="address_line2" class="w-full px-3 py-2 border rounded" />
                @error('address_line2')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                @enderror
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            <div>
                ...
                <x-base.form-input type="text" wire:model="city" class="w-full px-3 py-2 border rounded" />
                @error('city')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                @enderror
            </div>
            <div>
                ...
                <select wire:model="state" class="w-full text-sm border-slate-200 shadow-sm rounded-md py-2 px-3 pr-8">
            ...
            <div>
                ...
                <x-base.form-input type="text" wire:model="zip_code" class="w-full px-3 py-2 border rounded" />
                @error('zip_code')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                @enderror
            </div>
        ...
        <div class="flex items-center mt-4">
            <x-base.form-check.input class="mr-2.5 border" type="checkbox" type="checkbox"
                wire:model="lived_three_years" />
    ...
    <div x-show="!$wire.lived_three_years" x-transition class="mb-6">
        ...
        @foreach ($previous_addresses as $index => $address)
            <div class="p-4 border rounded bg-gray-50 mb-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    <div>
                        <label class="block mb-1">City *</label>
                        <x-base.form-input type="text" wire:model="previous_addresses.{{ $index }}.city"
                            class="w-full px-3 py-2 border rounded" />
                    ...
                    <div>
                        <label class="block mb-1">ZIP Code *</label>
                        <x-base.form-input type="text" wire:model="previous_addresses.{{ $index }}.zip_code"
                            class="w-full px-3 py-2 border rounded" />
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label class="block mb-1">From Date *</label>
                        <input type="date" wire:model="previous_addresses.{{ $index }}.from_date"
                            class="w-full px-3 py-2 border rounded">
        ...
        {{-- <button type="button" wire:click="addPreviousAddress"
            class="px-4 py-2 bg-gray-200 rounded hover:bg-gray-300">
            Add Previous Address
        </button> --}}
        <x-base.button type="button" wire:click="addPreviousAddress" class="inline-block w-64" variant="primary">
            Add Previous Address
        </x-base.button>
    </div>
    ...
    <div class="flex justify-between mt-8">
        <div>
            ...
            <x-base.button type="button" wire:click="previous" class="inline-block w-44"  variant="secondary">
                Previous
            </x-base.button>
        ...
        <div class="flex space-x-2">
            ...
            <x-base.button type="button" wire:click="saveAndExit" class="inline-block w-34"
