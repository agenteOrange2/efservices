<div class="bg-white p-4 rounded-lg shadow mb-6">
    ...
    <div class="mb-6 border-b pb-4">
        <div class="flex justify-between items-center mb-4">
            ...
            <button type="button" wire:click="addLicense" class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">
        ...
        <div class="mb-4">
            ...
            <input type="text" wire:model="current_license_number" class="w-full px-3 py-2 border rounded">
            ...
            <div class="license-entry border rounded-lg p-4 mb-4">
                ...
                <div class="mb-4">
                    <div class="flex items-center mb-2">
                        <input type="checkbox" wire:model="licenses.{{ $index }}.is_cdl" id="is_cdl_{{ $index }}"
    ...
    <div class="mb-6 pb-4">
        <div class="flex justify-between items-center mb-4">
            ...
            <button type="button" wire:click="addExperience" class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">
            ...
            <div class="experience-entry border rounded-lg p-4 mb-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <input type="number" wire:model="experiences.{{ $index }}.years_experience" min="0" max="10" step="1"
                            class="w-full text-sm border-slate-200 shadow-sm rounded-md py-2 px-3">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="number" wire:model="experiences.{{ $index }}.miles_driven" min="0" step="1"
                            class="w-full text-sm border-slate-200 shadow-sm rounded-md py-2 px-3">
