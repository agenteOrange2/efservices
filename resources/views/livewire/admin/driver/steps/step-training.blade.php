<div class="bg-white p-4 rounded-lg shadow" >
    ...
    <div class="flex items-center mb-4">
        <input type="checkbox" 
               wire:model="has_attended_training_school"
            ...
            <div class="border p-4 rounded-lg mb-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    @if(count($training_schools) > 1)
                        <button type="button" wire:click="removeTrainingSchool({{ $index }})" class="text-red-500 text-sm">
                ...
                <div class="mb-4">
                    <div class="flex items-center mb-2">
                        <input class="form-checkbox h-4 w-4 text-primary border-gray-300 rounded mr-2" type="checkbox"
                            wire:model="training_schools.{{ $index }}.graduated" id="graduated_{{ $index }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" id="skill_hazmat_{{ $index }}" value="hazardous_material"
                                ...
                                class="form-checkbox h-4 w-4 text-primary border-gray-300 rounded mr-2">
                            <label for="skill_hazmat_{{ $index }}" class="text-sm">Hazardous Material</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" id="skill_combination_{{ $index }}" value="combination_vehicle"
                                ...
                                class="form-checkbox h-4 w-4 text-primary border-gray-300 rounded mr-2">
                            <label for="skill_combination_{{ $index }}" class="text-sm">Combination Vehicle</label>
                        </div>
                        <div class="flex items-center">
                    ...
                    <div class="mt-6 border-t border-slate-200/60 bg-slate-50 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
                        @foreach($school['temp_certificate_tokens'] ?? [] as $tokenIndex => $certFile)
                            <div class="flex flex-col bg-gray-50 p-2 rounded mb-1 relative">
                                ...
                                <div class="w-full h-32 mb-2 bg-gray-200 flex items-center justify-center rounded overflow-hidden">
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex-1 overflow-hidden">
                                        <span class="text-sm truncate block">{{ $certFile['filename'] ?? 'Document' }}</span>
                                    </div>
                                    <button type="button" wire:click="removeCertificate({{ $index }}, {{ $tokenIndex }})"
