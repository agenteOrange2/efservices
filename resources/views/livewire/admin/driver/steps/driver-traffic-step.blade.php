<div class="bg-white p-4 rounded-lg shadow">
    ...
    <div class="flex items-center mb-4">
        <input type="checkbox" wire:model.live="has_traffic_convictions" 
        ...
        <label for="has_traffic_convictions" class="text-sm">
            Have you had any traffic violation convictions or forfeitures (other than parking violations) in the past
