<div>
    ...
    <div class="mb-4">
        ...
        <select wire:model="applying_position" class="w-full px-3 py-2 border rounded">
        ...
        <div x-show="$wire.applying_position === 'other'" x-transition class="mt-2">
            ...
            <input type="text" wire:model="applying_position_other" class="w-full px-3 py-2 border rounded">
    ...
    <div class="p-4 border rounded bg-gray-50 mb-6">
        ...
        <div class="mb-4">
            <label class="flex items-center">
                <input type="checkbox" wire:model="has_twic_card" class="mr-2">
            ...
            <div x-show="$wire.has_twic_card" x-transition class="mt-2">
                ...
                <input type="date" wire:model="twic_expiration_date" class="w-full px-3 py-2 border rounded">
    ...
    <div class="mb-4">
        ...
        <input type="input" wire:model="expected_pay" class="w-full px-3 py-2 border rounded" placeholder="e.g. $25/hour">
    </div>
    
    <!-- Referral Source -->
    <div class="mb-6">
        <label class="block mb-1">Referral Source *</label>
        <select wire:model="how_did_hear" class="w-full px-3 py-2 border rounded">
        ...
        <div x-show="$wire.how_did_hear === 'employee_referral'" x-transition class="mt-2">
            ...
            <input type="text" wire:model="referral_employee_name" class="w-full px-3 py-2 border rounded">
                ...
                <div class="p-4 border rounded bg-gray-50 mb-4">
                    <div class="flex justify-between mb-2">
                        ...
                        @if (count($work_histories) > 1)
                            <button type="button" wire:click="removeWorkHistory({{ $index }})" class="text-red-500">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input type="text" wire:model.defer="work_histories.{{ $index }}.previous_company" class="w-full px-3 py-2 border rounded">
                        ...
                        <div>
                            ...
                            <input type="text" wire:model.defer="work_histories.{{ $index }}.position" class="w-full px-3 py-2 border rounded">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input type="date" wire:model.defer="work_histories.{{ $index }}.start_date" class="w-full px-3 py-2 border rounded">
                        ...
                        <div>
                            ...
                            <input type="date" wire:model.defer="work_histories.{{ $index }}.end_date" class="w-full px-3 py-2 border rounded">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" wire:model.defer="work_histories.{{ $index }}.location" class="w-full px-3 py-2 border rounded">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" wire:model.defer="work_histories.{{ $index }}.reason_for_leaving" class="w-full px-3 py-2 border rounded">
                    </div>
                    
                    <div class="mb-4">
                        <label class="block mb-1">Reference Contact</label>
                        <input type="text" wire:model.defer="work_histories.{{ $index }}.reference_contact" class="w-full px-3 py-2 border rounded" placeholder="Name and phone number">
                    </div>
                </div>
            @endforeach
            
            <button type="button" wire:click="addWorkHistory" class="px-4 py-2 bg-gray-200 rounded hover:bg-gray-300">
                Add Work History
            </button>
        </div>
    </div>
