                ...
                <div class="p-4 border rounded bg-gray-50 mb-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <input type="text" wire:model.defer="work_histories.{{ $index }}.position"
                                class="w-full px-3 py-2 border rounded">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input type="date" wire:model.defer="work_histories.{{ $index }}.start_date"
                                class="w-full px-3 py-2 border rounded">
                        ...
                        <div>
                            ...
                            <input type="date" wire:model.defer="work_histories.{{ $index }}.end_date"
                                class="w-full px-3 py-2 border rounded">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" wire:model.defer="work_histories.{{ $index }}.reference_contact"
