                        ...
                        <div class="mt-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="border rounded-lg p-4 bg-white shadow-sm">
                                    ...
                                    <div class="text-sm">
                                        @php
                                            $recordDocuments = collect($generatedPdfs)->filter(function($pdf) {
                                        ...
                                        @if(count($recordDocuments) > 0)
                                            <ul class="divide-y">
                                                @foreach($recordDocuments as $key => $pdf)
                                                    <li class="py-2 flex justify-between items-center">
                                                        <span class="truncate">{{ $pdf['name'] }}</span>
                                                        <a href="{{ $pdf['url'] }}" target="_blank" class="text-blue-600 hover:underline ml-2">View</a>
                                                    </li>
                                        ...
                                        @else
                                            <p class="text-slate-500 italic">No record documents uploaded</p>
                                        @endif
                                    </div>
                                </div>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-4">
                                            <label for="document-description" class="block font-medium text-sm text-gray-700">Descripción</label>
                                            <input id="document-description" type="text" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" wire:model="documentDescription" placeholder="Ingrese una descripción para el documento">
