<div class="bg-white p-4 rounded-lg shadow">
    ...
    <div class="flex items-center mb-4">
        <input type="checkbox" wire:model="has_accidents" id="has_accidents" class="form-checkbox h-4 w-4 text-primary border-gray-300 rounded mr-2">
        <label for="has_accidents" class="text-sm">Have you had any accidents in the previous three years?</label>
    </div>
