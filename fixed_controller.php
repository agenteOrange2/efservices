...
class DriverTestingController extends Controller
{
    ...
    public function edit(DriverTesting $driverTesting)
    {
        ...
        return view('admin.driver-testings.edit', compact('driverTesting', 'locations', 'statuses', 'testTypes', 'testResults', 'billOptions'));
    }
     ...
     */
    public function downloadPdf(DriverTesting $driverTesting)
    {
        $pdfMedia = $driverTesting->getFirstMedia('drug_test_pdf');
        
        if ($pdfMedia) {
            return response()->download($pdfMedia->getPath(), 'driver_testing_' . $driverTesting->getKey() . '.pdf');
        }
