...
class ApplicationStep extends Component
{
    ...
    public function updatedSelectedDriverType($value)
    {
        ...
        // CRITICAL: Normalizar el valor de third a third_party (NO third_party)
        ...
        if ($value === 'third') {
            ...
            Log::info('CRITICAL: Normalized third to third_party', [
                ...
                'driver_id' => $this->driverId,
                'note' => 'DB ENUM expects third_party not third_party'
            ]);
        }
    ...
    private function createVehicleDriverAssignment($type)
    {
        try {
            ...
            // CRITICAL: Normalizar third a third_party (NO third_party)
            // La tabla vehicle_driver_assignments tiene ENUM con valores: owner_operator, third_party, company_driver
            if ($type === 'third') {
                $type = 'third_party';
